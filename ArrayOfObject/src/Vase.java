...
public class Vase extends Item {
    ...
    public Vase(int height, String material, String color, int value, String creator) {
        super(value, creator);
        this.height = height;
    ...
    public String toString() {
        return "type: Vase    " + ", height = " + height + ", material = " + material + ", color = " + color + ", creator = " + creator;
    }
