public class Statue extends Item{
    ...
    public Statue(int weight, String colour, String material, int value, String creator) {
        super(value, creator);
        this.weight = weight;
        this.colour = colour;
    ...
    public String toString() {
        return "type: Statue  " + ", weight = " + weight + ", colour = " + colour + ", material = " + material + ", creator = " + creator;
    }
